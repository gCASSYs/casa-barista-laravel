                          ...
                          <tr>
                            ...
                            <td>
                              @if ($banner->imagem_banner)
                                <img
                                  src="{{ asset($banner->imagem_banner) }}"
                            ...
                            {{--TITULO BANNER--}}
                            <td>
                              <span class="badge text-bg-success" style="background-color: #4b2e1e !important;">{{ $banner->titulo_banner }}</span>
                            </td>
                            {{--STATUS DO TITULO--}}
                            <td>
                              @if ($banner->status_banner == 'ATIVO')
                                <span class="badge text-bg-success" style="background-color: #28a745 !important;">Ativo</span>
                              @else
